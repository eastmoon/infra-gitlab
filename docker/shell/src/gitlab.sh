...
. ${MODULES_DIRECTORY}/gitlab/op/info.sh
. ${MODULES_DIRECTORY}/gitlab/op/groups.sh
. ${MODULES_DIRECTORY}/gitlab/op/users.sh
. ${MODULES_DIRECTORY}/gitlab/op/projects.sh
. ${MODULES_DIRECTORY}/gitlab/scm/repository.sh
