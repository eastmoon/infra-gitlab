...
# Declare variable
TEST_REPO_NAME_1=test-case-3.1-unprotect-master-`date "+%Y%m%d%H%M%S"`
...
## Unprotect master
### Setting unprotect
unprotect-branch ${TEST_REPO_NAME_1} master

## Unprotect master and protect release
### Initial repository
git-init QA ${TEST_REPO_NAME_2} master
### Create release branch
git-init-branch ${TEST_REPO_NAME_2} release
### Setting unprotect branch
unprotect-branch ${TEST_REPO_NAME_2} master
### Setting protect branch
protect-branch ${TEST_REPO_NAME_2} release

## Unprotect master and protect white card
### Initial repository
git-init QA ${TEST_REPO_NAME_3} master
### Setting unprotect branch
unprotect-branch ${TEST_REPO_NAME_3} master
### Setting protect branch
